...
function createGuideElement(element) {
    ...
    d.open();
    d.write("<!DOCTYPE html><html class='gradient chrome'><head></head><body style='padding: 20px; background: rgba(251, 251, 251,1); border-top:1px solid #e1e1e1'>"+ source.textContent +"</body></html>");
